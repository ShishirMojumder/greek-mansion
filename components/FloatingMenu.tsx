...
export default function FloatingMenu() {
  ...
  return <motion.div ref={ref} className="fixed right-3 top-[15px] z-[60] flex items-start gap-2 md:right-10 md:gap-3" initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .55, ease }}>
    <motion.div className="hidden rounded-full shadow-lg shadow-navy/20 sm:block" animate={{opacity:open?0:1,x:open?14:0,pointerEvents:open?"none":"auto"}} transition={{duration:.25}}><ArrowFillButton btnText="Order Now" href="https://www.ubereats.com/ca/store/greek-mansion/2jMowxE1Ts6w_sOBYT_BQA?utm=greekfooddelivery.ca" target="_blank" rel="noreferrer" aria-label="Order Greek Mansion on Uber Eats" className="font-label"/></motion.div>
