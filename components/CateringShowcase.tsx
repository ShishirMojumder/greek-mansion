...
export default function CateringShowcase() {
  ...
  return <section ref={sectionRef} className="px-5 py-14 md:px-10 md:py-24"><div ref={wrapRef} className="mx-auto max-w-[1360px] bg-white p-7 md:p-16"><div className="grid items-center gap-12 md:grid-cols-[1fr_1.1fr]"><div ref={copyRef}><p className="eyebrow">Greek Mansion Catering</p><h2 className="display mt-5 text-5xl uppercase text-navy md:text-7xl">Bring <span className="accent">Greece</span><br/>to the gathering</h2><div className="mt-5"><HandwritingText text="Gather generously" height="2.9rem" className="text-gold" duration={1.6}/></div><p className="mt-5 max-w-md text-sm leading-7 text-ink/60">Corporate lunches, milestone moments, family celebrations. We bring generous Greek flavours—and make hosting feel effortless.</p><Button href="/catering" className="mt-8">Request catering</Button></div><div ref={mediaRef}><article className="group rounded-[28px] bg-marble p-3 shadow-2xl shadow-navy/10 ring-1 ring-navy/10 transition-transform duration-500 hover:-translate-y-2 md:p-4"><div className="relative aspect-[4/3] overflow-hidden rounded-[20px] bg-white"><Image src="/images/real-food/greekmansion-familymeal-native.jpg" alt="A real Greek Mansion family meal prepared for sharing" fill className="object-cover object-center transition-transform duration-700 ease-out group-hover:scale-[1.04]" sizes="600px"/></div></article></div></div></div></section>;
}
