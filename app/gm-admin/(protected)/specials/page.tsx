  ...
  if (!specials) {
    return (
      <div className="space-y-4">
        <h1 className="text-xl font-bold text-navy">Specials</h1>
        <p className="rounded-xl border border-dashed border-navy/20 bg-white p-6 text-sm text-ink/55">
          There is no &ldquo;Specials&rdquo; category yet.{" "}
          <Link href="/gm-admin/categories" className="font-semibold text-navy">
            Create one
          </Link>{" "}
